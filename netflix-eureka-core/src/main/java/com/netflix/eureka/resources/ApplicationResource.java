...
public class ApplicationResource {
	 ...
	 * @param acceptHeader the accept header of the request to indicate whether to
	 *                     serve JSON or XML data.
	 * @return the response containing information about a particular application.
	 */
	@GET
	 ...
	 * @param isReplication a header parameter containing information whether this
	 *                      is replicated from other nodes.
	 */
	@POST
	...
	public Response addInstance(InstanceInfo info,
		...
		if (isBlank(info.getId())) {
			...
			return Response.status(400)
					.entity("Mismatched appName, expecting " + appName + " but was " + info.getAppName()).build();
		...
		if (dataCenterInfo instanceof UniqueIdentifier) {
			...
			if (isBlank(dataCenterInfoId)) {
				boolean experimental = "true"
						.equalsIgnoreCase(serverConfig.getExperimental("registration.validation.dataCenterInfoId"));
				if (experimental) {
